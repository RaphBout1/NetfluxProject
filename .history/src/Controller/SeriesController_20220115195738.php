...
class SeriesController extends AbstractController
{
    ...
    /**
     * @Route("/series", name="tri_croissant", methods={"GET"})
     */
    public function tri(EntityManagerInterface $entityManager, PaginatorInterface $paginator, Request $request, calculMoyenne $calculMoyenne): Response
    {
        $calculMoyenne->setMoyenne($entityManager);
        ...
        $series = $repository->findBy(['noteUser' => 'DESC'], dump('noteUser')), /* query NOT result */
            $request->query->getInt('page', 1), /*page number*/
            12 /*limit per page*/
        );
