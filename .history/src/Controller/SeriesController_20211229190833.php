...
class SeriesController extends AbstractController
{
     ...
     public function searchBar()
    {
        $form = $this->createFormBuilder()
            ...
            ->getForm();
        return $this->render('series/searchBar.html.twig', [
     ...
     */
    public function handleSearch(Request $request, Series $series,EntityManagerInterface $entityManager )
    {
        $query = $request->request->get('form')['query'];
        if($query) {
            $articles = $series->findArticlesByName($query,$entityManager);
        }
