...
class SeriesController extends AbstractController
{
    ...
    /**
     * @Route("/series/add/{imdbID}", name="series_add", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager, CallApiService $callApiService): Response
    {
        dump($callApiService->getApi('tt8962124'));
        $response = $callApiService->getApi('tt8962124');
    }
