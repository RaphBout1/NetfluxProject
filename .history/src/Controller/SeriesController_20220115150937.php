...
class SeriesController extends AbstractController
{
    ...
    /**
     * @Route("/series", name="tris_croissant", methods={"GET"})
     */
    public function trisCroissant(EntityManagerInterface $entityManager, PaginatorInterface $paginator, Request $request, calculMoyenne $calculMoyenne): Response
    {
        $calculMoyenne->setMoyenne($entityManager);
        ...
        $series = $paginator->paginate(
            $repository->findNotesCroissantes($search), /* query NOT result */
            $request->query->getInt('page', 1), /*page number*/
            12 /*limit per page*/
        );
